...
​	页面布局与风格规范宜尽量与总行标准版本风格保持一致。使客户在使用平台的时候，不会因为风格变化过于明显而感觉到差异。页![f4f10ef60b83056c9b5ea00d0baa8280](images\f4f10ef60b83056c9b5ea00d0baa8280.JPG)面跳转应使客户觉得是在同一平台的不同功能之间进行跳转。
